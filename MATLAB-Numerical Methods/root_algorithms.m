function [root, T] = root_algorithms(method, eq, a, b, tol, maxIter)
    syms x; f = matlabFunction(str2sym(eq));
    switch method
        ...
        case 'Newton-Raphson', df = matlabFunction(diff(str2sym(eq), x)); [root, T] = run_newton(f, df, a, tol, maxIter);
